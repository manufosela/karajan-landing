...
template: splash
hero:
  tagline: "v2.7.1 — addyosmani/agent-skills as first-source process catalog + restored platform binaries. 20+ lifecycle skills (TDD, code-review, security, performance, git-workflow…) injected per role BEFORE OpenSkills stack skills, shallow-cloned and refreshed weekly. GitHub Releases now ship linux-x64 / darwin-arm64 / win-x64 binaries again after a 5-release SEA workflow bug (v2.4.1 → v2.7.0). 3 672 tests, 285 files."
  image:
