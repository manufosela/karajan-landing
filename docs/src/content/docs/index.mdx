...
template: splash
hero:
  tagline: "v2.1.0 — Auto-HU Decomposition: big tasks auto-split into atomic HUs, each running as an independent sub-pipeline with its own branch and PR. Brain + Solomon Judge included."
  image:
