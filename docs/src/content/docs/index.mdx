...
template: splash
hero:
  tagline: "v2.0.2 — Karajan Brain + Solomon Judge: AI-powered orchestration with typed feedback, output verification, and 40-70% token savings. Code, review, test, secure — in a single command."
  image:
