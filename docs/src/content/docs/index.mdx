...
<CardGrid stagger>
  ...
  <Card title="5 558+ Automated Tests" icon="approve-check">
...
**Coming in v2.27.0+** — chokidar watcher (live re-indexing), AST source chunker, BM25 + cosine hybrid scoring, OpenAI/Voyage embedder adapters for users without local Docker.
