...
template: splash
hero:
  tagline: "v1.30.0 — Role-based AI orchestrator: 15 roles, 5 agents, deterministic guards. Code, review, test, secure — in a single command."
  image:
...
<CardGrid stagger>
  <Card title="Multi-Agent Pipeline" icon="rocket">
    15 configurable roles: discover, triage, researcher, architect, planner, coder, refactorer, sonar, impeccable, reviewer, tester, security, solomon, commiter, hu-reviewer.
  </Card>
  ...
  <Card title="1847+ Automated Tests" icon="approve-check">
