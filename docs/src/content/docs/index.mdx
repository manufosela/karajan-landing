...
<CardGrid stagger>
  ...
  <Card title="5 670+ Automated Tests" icon="approve-check">
...
**Coming in v2.28.0+** — chokidar watcher (live re-indexing), AST source chunker (tree-sitter / @babel/parser), BM25 + cosine hybrid scoring, OpenAI / Voyage embedder adapters for users without local Docker.
