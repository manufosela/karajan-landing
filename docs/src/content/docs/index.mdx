...
template: splash
hero:
  tagline: "Your agent orchestrates, Karajan governs: method playbook, cross-AI review, git gates, RAG-first. Plus the classic multiagent pipeline as headless mode."
  image:
...
### v4.1.4 — the self-healing loop closed its first cycle (current)
