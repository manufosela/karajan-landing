...
template: splash
hero:
  tagline: "v1.27.1 — Role-based AI orchestrator: 14 roles, 5 agents, deterministic guards. Code, review, test, secure — in a single command."
  image:
...
<CardGrid stagger>
  ...
  <Card title="1688+ Automated Tests" icon="approve-check">
