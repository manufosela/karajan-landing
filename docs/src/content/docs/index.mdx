...
template: splash
hero:
  tagline: "v1.32.0 — Role-based AI orchestrator: 15 roles, 5 agents, deterministic guards. Code, review, test, secure — in a single command."
  image:
...
<CardGrid stagger>
  ...
  <Card title="1875+ Automated Tests" icon="approve-check">
