...
template: splash
hero:
  tagline: "v1.29.0 — Role-based AI orchestrator: 14 roles, 5 agents, deterministic guards. Code, review, test, secure — in a single command."
  image:
...
<CardGrid stagger>
  ...
  <Card title="1807+ Automated Tests" icon="approve-check">
