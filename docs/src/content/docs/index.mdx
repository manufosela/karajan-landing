...
template: splash
hero:
  tagline: "v1.25.0 — Role-based AI orchestrator: 14 roles, 5 agents, deterministic guards. Code, review, test, secure — in a single command."
  image:
...
<CardGrid stagger>
  ...
  <Card title="Zero-Config Pipeline" icon="setting">
    Auto-detects TDD based on project test framework. Auto-manages SonarQube Docker lifecycle and config generation. Skips sonar/TDD for infra and doc tasks automatically.
  </Card>
  <Card title="1605+ Automated Tests" icon="approve-check">
