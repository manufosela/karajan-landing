...
template: splash
hero:
  tagline: "v2.6.0 — Modular orchestrator: 2 000-line monolith split into a 22-line barrel + flow-runner + StageExecutor contract. Infrastructure DI for unit-testable agents. Valibot config validation catches typos at load time. HU Board auto-start with a prominent URL banner. 3 638 tests, 283 files."
  image:
