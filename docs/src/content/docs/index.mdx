...
template: splash
hero:
  tagline: "v1.21.1 — Role-based AI orchestrator: 13 roles, 5 agents, deterministic guards. Code, review, test, secure — in a single command."
  image:
...
<CardGrid stagger>
  ...
  <Card title="1559+ Automated Tests" icon="approve-check">
    128 test files covering every pipeline role, guard, config option, and MCP tool. Full suite runs in under 14 seconds with Vitest.
  </Card>
