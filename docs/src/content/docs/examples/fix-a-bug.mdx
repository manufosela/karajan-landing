...
Execute tasks from your [Planning Game](https://github.com/manufosela/planning-game-xp) project management board:
...
Karajan fetches the full task context (description, acceptance criteria) from [Planning Game](https://github.com/manufosela/planning-game-xp) and updates the card status on completion.
