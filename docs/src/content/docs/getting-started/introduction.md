...
Karajan Code is tested with **2275 automated tests** across 179 test files, covering every pipeline role, guard, config option, and MCP tool. The test suite runs in under 14 seconds using Vitest.
