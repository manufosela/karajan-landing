...
if a step needs sudo or kj exits with code 3, STOP, show me the exact
commands and WAIT for my go-ahead.
```
...
needs sudo, an account, or kj exits with code 3.
```
...
anything needs sudo or kj exits with code 3.
```
