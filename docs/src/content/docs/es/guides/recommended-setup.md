...
No necesitas las seis en el día uno. Empieza con SSH multi-cuenta + branch protection + el denylist del agente que uses; añade el usuario restringido la primera vez que delegues algo no trivial.
