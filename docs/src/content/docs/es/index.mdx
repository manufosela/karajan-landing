...
template: splash
hero:
  tagline: "v2.4.0 — Tests de Aceptación Ejecutables: cada HU ejecuta comandos shell tras cada iteración del coder. Todos pasan → aprobado. Alguno falla → Brain diagnostica con el error exacto. Demo: 6 HUs, 280 tests, 97% cobertura, 0 vulnerabilidades."
  image:
...
<CardGrid stagger>
  <Card title="Tests de Aceptación Ejecutables (v2.4)" icon="approve-check-circle">
