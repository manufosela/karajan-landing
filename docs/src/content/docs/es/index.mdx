...
template: splash
hero:
  tagline: "v2.7.3 — Tarea desde un .md (kj run --task-file spec.md, idéntico en MCP). El CLI escribe por fin .kj/run.log como el MCP, así kj-tail funciona tanto si Claude Code lanza kj por Bash como por MCP. Node 18 LTS soportado de verdad. kj-tail v1.38.0 espera al log en vez de salir. Incluye todo v2.7: addyosmani/agent-skills como fuente primaria y summary.md mostrando slugs por rol. 3 702 tests, 287 ficheros."
  image:
