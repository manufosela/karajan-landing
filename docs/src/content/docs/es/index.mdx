...
<CardGrid stagger>
  ...
  <Card title="5 374+ Tests Automatizados" icon="approve-check">
    455 ficheros de test cubriendo cada rol, guard, opción de config, herramienta MCP y el paquete completo del HU Board. Suite completa en unos 60 s con Vitest. Los tests de subsistemas opt-in (brain, ci, sonar, hu-board, webperf) llevan la etiqueta `[opt-in: <feature>]` y se pueden saltar con `KJ_SKIP_ALL_OPTIN=1`.
  </Card>
