...
template: splash
hero:
  tagline: "v2.1.1 — Auto-descomposición en HUs: tareas grandes se dividen automáticamente en HUs atómicas, cada una como sub-pipeline con su rama y PR. Brain + Solomon Judge incluidos."
  image:
