...
template: splash
hero:
  tagline: "v1.23.0 — Orquestador de IA basado en roles: 13 roles, 5 agentes, guards deterministas. Código, revisión, tests, seguridad — en un solo comando."
  image:
...
<CardGrid stagger>
  ...
  <Card title="1577+ Tests Automatizados" icon="approve-check">
