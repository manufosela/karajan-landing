...
template: splash
hero:
  tagline: "v2.7.2 — Observabilidad de skills. summary.md muestra ahora qué slugs de proceso addyosmani se resolvieron por rol + los OpenSkills instalados/recomendados. kj-tail v1.37.0 marca los eventos [skills:*] con 🎯 (magenta en éxito, amarillo en degradación grácil). Incluye todo el conjunto v2.7: addyosmani/agent-skills como catálogo de primera fuente y binarios SEA restaurados. 3 679 tests, 285 ficheros."
  image:
