...
### v3.5.1 — PHP de primera en el harness (actual)
...
Métricas de caché normalizadas entre Anthropic, OpenAI/Codex, Gemini, aider y opencode, mostradas como badge `🎯 N%` en el HU Board, persistidas en `board.db` y emitidas en la telemetría `pipeline_complete`.
