...
template: splash
hero:
  tagline: "v2.7.1 — addyosmani/agent-skills como catálogo de proceso de primera fuente + binarios de plataforma restaurados. 20+ skills de ciclo de vida (TDD, code-review, security, performance, git-workflow…) inyectados por rol ANTES de los skills de stack de OpenSkills, clonado superficial y refresco semanal. Las GitHub Releases vuelven a publicar binarios linux-x64 / darwin-arm64 / win-x64 tras un bug de 5 releases en el workflow SEA (v2.4.1 → v2.7.0). 3 672 tests, 285 ficheros."
  image:
