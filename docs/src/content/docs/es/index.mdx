...
template: splash
hero:
  tagline: "v2.0.0 — Karajan Brain + Solomon Judge: orquestación con IA, feedback tipado, verificación de outputs y 40-70% de ahorro de tokens. Código, revisión, tests, seguridad — en un solo comando."
  image:
