...
<CardGrid stagger>
  ...
  <Card title="4 984+ Tests Automatizados" icon="approve-check">
    418 ficheros de test cubriendo cada rol, guard, opción de config y herramienta MCP. Suite completa en unos 60 s con Vitest. Los tests de subsistemas opt-in (brain, ci, sonar, hu-board, webperf) llevan la etiqueta `[opt-in: <feature>]` y se pueden saltar con `KJ_SKIP_ALL_OPTIN=1`.
  </Card>
