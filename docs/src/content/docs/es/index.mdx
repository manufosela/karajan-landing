...
template: splash
hero:
  tagline: "v1.30.0 — Orquestador de IA basado en roles: 15 roles, 5 agentes, guards deterministas. Código, revisión, tests, seguridad — en un solo comando."
  image:
...
<CardGrid stagger>
  <Card title="Pipeline Multi-Agente" icon="rocket">
    15 roles configurables: discover, triage, researcher, architect, planner, coder, refactorer, sonar, impeccable, reviewer, tester, security, solomon, commiter, hu-reviewer.
  </Card>
  ...
  <Card title="1847+ Tests Automatizados" icon="approve-check">
