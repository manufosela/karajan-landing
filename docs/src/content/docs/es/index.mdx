...
template: splash
hero:
  tagline: "v2.6.0 — Orquestador modular: monolito de 2 000 líneas dividido en un barrel de 22 líneas + flow-runner + contrato StageExecutor. DI de infraestructura para tests unitarios reales de los agents. Validación de config con Valibot. HU Board con banner de URL prominente. 3 638 tests, 283 ficheros."
  image:
