...
<CardGrid stagger>
  ...
  <Card title="5 436+ Tests Automatizados" icon="approve-check">
...
**Viene en v2.26.0+** — chokidar watcher (re-indexing en vivo), chunker AST de fuentes, scoring híbrido BM25 + cosine.
