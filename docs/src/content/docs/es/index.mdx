...
template: splash
hero:
  tagline: "v1.20.0 — Orquestador de IA basado en roles: 13 roles, 5 agentes, guards deterministas. Código, revisión, tests, seguridad — en un solo comando."
  image:
...
<CardGrid stagger>
  ...
  <Card title="1549+ Tests Automatizados" icon="approve-check">
    127 ficheros de test cubriendo cada rol, guard, opción de config y herramienta MCP. Suite completa en menos de 14 segundos con Vitest.
  </Card>
