...
template: splash
hero:
  tagline: "v2.7.0 — addyosmani/agent-skills como catálogo de skills de proceso de primera fuente. Karajan descarga 20+ skills de ciclo de vida (TDD, code-review, security, performance, git-workflow…) del repo curado de Addy Osmani e inyecta los que tocan a cada rol ANTES de los skills de stack de OpenSkills. Clone superficial + refresco semanal + degradación grácil si falta git. 3 672 tests, 285 ficheros."
  image:
