...
template: splash
hero:
  tagline: "v1.25.1 — Orquestador de IA basado en roles: 14 roles, 5 agentes, guards deterministas. Código, revisión, tests, seguridad — en un solo comando."
  image:
...
<CardGrid stagger>
  ...
  <Card title="1623+ Tests Automatizados" icon="approve-check">
