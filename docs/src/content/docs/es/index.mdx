...
template: splash
hero:
  tagline: "v1.32.0 — Orquestador de IA basado en roles: 15 roles, 5 agentes, guards deterministas. Código, revisión, tests, seguridad — en un solo comando."
  image:
...
<CardGrid stagger>
  ...
  <Card title="1875+ Tests Automatizados" icon="approve-check">
