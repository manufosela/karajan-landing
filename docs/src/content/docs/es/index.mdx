---
title: Karajan Code
description: Orquestador de IA basado en roles con 13 roles, 5 agentes, guards deterministas, TDD, SonarQube y revision de codigo automatizada.
template: splash
hero:
  tagline: "v1.21.1 — Orquestador de IA basado en roles: 13 roles, 5 agentes, guards deterministas. Código, revisión, tests, seguridad — en un solo comando."
  image:
...
<CardGrid stagger>
  ...
  <Card title="Servidor MCP" icon="puzzle">
    18 herramientas via MCP — incluyendo `kj_discover`, `kj_triage`, `kj_researcher`, `kj_architect` para ejecución standalone de roles, `kj_preflight` para configuración confirmada por humano y `kj_status` para estado parseado en vivo. Notificaciones de progreso en tiempo real para todas las herramientas.
  </Card>
  ...
  <Card title="1559+ Tests Automatizados" icon="approve-check">
    128 ficheros de test cubriendo cada rol, guard, opción de config y herramienta MCP. Suite completa en menos de 14 segundos con Vitest.
  </Card>
