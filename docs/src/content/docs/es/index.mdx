...
template: splash
hero:
  tagline: "Tu agente orquesta, Karajan gobierna: playbook del método, revisión IA-cruzada, gates en git, RAG-first. Y el pipeline multiagente clásico como modo headless."
  image:
...
### v4.1.4 — el ciclo self-healing cerró su primera vuelta (actual)
