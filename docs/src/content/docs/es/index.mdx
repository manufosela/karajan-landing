...
template: splash
hero:
  tagline: "v2.12.0 — Release de medición de calidad. Aterrizan dos features juntas: cada `kj run` contra un plan conocido ahora puntúa cuánto el coder siguió el plan (métrica determinista 0–100 de adherencia al plan, cuatro componentes ponderados, renderizada en `summary.md`); y una pequeña regression suite de golden-tasks (`todo-rest-api`, `npm-package-cli`, `react-counter-component`) detecta caídas de calidad de output entre versiones de Karajan antes del npm publish. Además, el shrink-budget de CI exime ahora los docs orientados a humanos del techo de 200 LOC, manteniendo capados los ficheros de reglas para IA (CLAUDE.md, AGENTS.md, role prompts). 3 PRs de plan adherence (#645–#647), 4 de golden tasks (#648, #650–#652), 1 de la política de CI (#649). 4 522 tests en 381 ficheros."
  image:
