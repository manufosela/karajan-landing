...
template: splash
hero:
  tagline: "v1.34.0 — Orquestador de IA basado en roles: 15 roles, 5 agentes, guards deterministas. Código, revisión, tests, seguridad — en un solo comando."
  image:
...
<CardGrid stagger>
  ...
  <Card title="1920+ Tests Automatizados" icon="approve-check">
