...
**24 roles especializados.** Triage, planner, coder, reviewer, sonar, solomon, audit y más, repartidos entre las fases pre-loop, iteración y post-loop. Ver [Roles del pipeline](/docs/es/handbook/pipeline-roles/) para el catálogo completo.
...
<div class="features-carousel" id="features-carousel">
  <div class="carousel-track">
    <div class="carousel-slide">
      ...
      <p>24 roles especializados — cada uno asignable a cualquier agente. Selección destacada: triage, planner, coder, reviewer, sonar, solomon, audit y más, repartidos entre las fases pre-loop, iteración y post-loop. Catálogo completo en <a href="/docs/es/handbook/pipeline-roles/">Roles del pipeline</a>.</p>
    </div>
    <div class="carousel-slide">
      <h3>5 Agentes IA</h3>
...
Karajan Code esta testeado con **2599 tests automatizados** en 200 ficheros de test, cubriendo cada rol del pipeline, guard, opción de config y herramienta MCP. La suite de tests se ejecuta en menos de 14 segundos con Vitest.
...
**Modo Orchestrator** — Servidor MCP completo con 27 herramientas. Pipeline multi-agente con orquestación de subprocesos, gestión de sesiones, tracking de presupuesto y resiliencia ante rate limits. Ideal para tareas complejas e integración CI/CD.
