...
description: 'Qué secciones de la documentación mencionan lo que acabas de cambiar — con el enlace duro código↔docs de los contratos.'
---

<!-- synced-from: manufosela/karajan-watch@v0.3.0:docs/drift.md · section-sha256: 7f392ad905dfc8f18ce5fef766dccf4bf27a51f21a12d29908aabf0fdbc96652
     NO EDITAR A MANO — regenerado con `npm run sync:family-docs` -->

Mismo esqueleto que el [análisis de impacto](../impact/) con el corpus
...
[`drift.yml`](https://github.com/manufosela/karajan-watch/blob/v0.3.0/.github/workflows/drift.yml) — como `impact.yml` pero
